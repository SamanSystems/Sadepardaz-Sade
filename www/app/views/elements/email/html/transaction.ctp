...
با سلام<br>
تراکنشی به ارزش <?php echo $trans['amount'];?> تومان، توسط <?php echo $trans['name'] ;?> از طريق دروازه پرداخت زرين پال، انجام شد.<br />
<br />
مقدار تراکنش: <?php echo $trans['amount'];?> تومان <br />
نام پرداخت کننده: <?php echo $trans['name'] ;?><br />
ايميل پرداخت کننده: <?php echo $trans['email'] ;?><br />
شماره ای يو: <?php echo $trans['au'] ;?><br />
توضيحات تراکنش: <?php echo $trans['desc'] ;?><br />
